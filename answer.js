...
class Person {
    constructor(name1 , name2, fromNation, born){
    this.firstName = name1;
    this.lastName = name2;
    this.nationality = fromNation;
    this.birthYear = born;
}
presentation(){ /* print1 */
...
presentationWithLastNameAndNationality() { /* print2 */
    return `My name is ${this.firstName} ${this.lastName} from ${this.nationality}.`;
}
presentationBirthYear(previousFunction) { /* print3 */
    this.birthYear = this.birthYear.slice (0, 4);
   return previousFunction + ` I was born ${this.birthYear}.` ;
}
...
Isaac = new Person("Isaac", "Newton", "England", "1643-01-04");





ANSWER = Isaac.presentation();
...
ANSWER = Isaac.presentationWithLastNameAndNationality();
 ...
 * Write your code below and put the answer into the variable ANSWER.
 */
let henri = new Person("Henri", "Becquerel","France", "1852-12-15")





ANSWER = henri.presentationBirthYear(henri.presentationWithLastNameAndNationality());
 ...
 */
 ...
 let albert = new Person("Albert", "Einstein", "Germany", "1879-03-14")


ANSWER = albert.presentationBirthYear(albert.presentationWithLastNameAndNationality());
